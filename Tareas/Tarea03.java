...
public class Tarea03 {
    ...
    *imponible (precio antes de impuestos), el tipo de IVA aplicado 
    *(general, reducido o superreducido) y el código promocional. 
    *Los tipos de IVA general, reducido y superreducido son del 21%, 10% y 4% respectivamente.
    *Los códi- gos promocionales pueden ser nopro, mitad, meno5 o 5porc que significan respectivamente
